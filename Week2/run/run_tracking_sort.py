...
def main():
    ...
    MAX_AGE = 3  # Maximum number of frames to keep alive a track without associated detections
    MIN_HITS = 15  # Minimum number of associated detections before track is confirmed
    IOU_THRESHOLD = 0.12198816644072724  # Minimum IoU for matching
